...
class CreatePDF(FPDF):
    ...
    def header(self):
        ...
        self.add_font(
            family='Avenir',
            style='',
            fname=r"C:\Users\mujoo\OneDrive\Documents\GitHub\CapstoneProject\API and Backend\Fonts\Avenir Book\avenir_lt_std_45_book.ttf",
            uni=True
        )
        ...
        self.add_font(
            family='Avenir',
            style='M',
            fname=r"C:\Users\mujoo\OneDrive\Documents\GitHub\CapstoneProject\API and Backend\Fonts\Avenir Medium\avenir_lt_std_65_medium.ttf",
            uni=True
        )
        ...
        self.add_font(
            family='Avenir',
            style='B',
            fname=r"C:\Users\mujoo\OneDrive\Documents\GitHub\CapstoneProject\API and Backend\Fonts\Avenir Black\avenir_lt_std_95_black.ttf",
            uni=True
        )

        self.image(
            r"C:\Users\mujoo\OneDrive\Documents\GitHub\CapstoneProject\API and Backend\Extras\Logo heart waves.jpg",
            10, 8, 25)
    ...
    def make_report(user, user_attrs):
        ...
        pdf.output(
            fr"C:\Users\mujoo\OneDrive\Documents\GitHub\CapstoneProject\API and Backend\Report\{user.first_name}"
...
class MakeReport(Resource):
    ...
    def send_report(fitbit_user):
        ...
        with open(
                rf"C:\Users\mujoo\OneDrive\Documents\GitHub\CapstoneProject\API and Backend\Report\{fitbit_user.first_name}{fitbit_user.last_name}_report.pdf",
                'rb') as f:
            data = f.read()
            f.close()
